...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset(env('ROOT').env('FRONT').env('ABOUT').'4/style.css')}}">
...
@section('js')
    ...
    <script src="{{asset(env('ROOT').env('FRONT').env('ABOUT').'3/script.js')}}"></script>
